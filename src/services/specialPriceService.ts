...
import { add,addAll, deleteOne, get, getAll, update } from './crudService';
...
export const addAllSpecialPrice = async (specialPriceToAdd: SpecialPriceRequestDTO[]) => {
    return addAll("specialPrice", specialPriceToAdd)
}
